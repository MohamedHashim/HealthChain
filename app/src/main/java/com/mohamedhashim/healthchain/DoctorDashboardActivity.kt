...
//        mPostCommentResponsese!!.requestStarted()
        ...
        val sr = object : StringRequest(Request.Method.POST, "http://ec2-18-216-204-179.us-east-2.compute.amazonaws.com:3000/api/patient", object : Response.Listener<String> {
